...
BATCH_EXECUTOR_JOB_DEFINITION_NAME = terraform_output.get("batch_job_definition_name","covalent-batch-jobs")
BATCH_EXECUTOR_QUEUE = terraform_output.get("batch_queue","covalent-batch-queue")
BATCH_EXECUTOR_EXECUTION_ROLE_NAME = terraform_output.get("batch_execution_role_name","ecsTaskExecutionRole")
BATCH_EXECUTOR_JOB_ROLE = terraform_output.get("batch_job_role_name","CovalentBatchJobRole")
BATCH_EXECUTOR_LOG_GROUP = terraform_output.get("batch_job_log_group_name","covalent-batch-job-logs")
...
executor_config = {
    ...
    "batch_job_definition_name": os.getenv("BATCH_EXECUTOR_JOB_DEFINITION_NAME", BATCH_EXECUTOR_JOB_DEFINITION_NAME),
    "batch_queue": os.getenv("BATCH_EXECUTOR_BATCH_QUEUE", BATCH_EXECUTOR_QUEUE),
    "batch_execution_role_name": os.getenv("BATCH_EXECUTOR_EXECUTION_ROLE_NAME", BATCH_EXECUTOR_EXECUTION_ROLE_NAME),
